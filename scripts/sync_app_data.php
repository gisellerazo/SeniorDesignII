...
$stmt->close();
if ($stmt = $mysqli->prepare("UPDATE device set status=?
where devname = 'LED2'")) { //update LED1
...
$out_json['SW2'] = $SW2_status; $out_json['LED2'] = $LED2_status;
